...
function setCanvas(){
    ...
    var str = ''
    for(var i=0; i < n; i++){
        str += '<canvas id="canvas'+ i +'" width="50" height="50"></canvas>'
    }
    console.log(str)
    canvasCollection[0].innerHTML = '<canvas id="canvas" width="600" height="600"></canvas>'
}
setCanvas()

var canvas = document.getElementById("canvas");
var GenerationH3 = document.getElementById("GenerationNo");
var EntityH3 = document.getElementById("CurrentEntity");
var scoreH3 = document.getElementById("CurrentBestScore");
var stepsH3 = document.getElementById("StepsLeft");
